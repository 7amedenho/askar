    ...
    <section className="relative bg-gray-50 dark:bg-slate-900 overflow-hidden">
      ...
      <div className="relative container px-6 py-10 mx-auto">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-300 text-center max-w-2xl mx-auto">
          We are dedicated to delivering exceptional services and sustainable solutions tailored to your needs.
        </p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2">
          ...
          <div className="p-6 hover:shadow-lg hover:-translate-y-2 duration-200 border rounded-xl bg-white dark:bg-slate-800 border-gray-200 dark:border-gray-700">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              Delivering the highest quality standards to meet and exceed your expectations.
            </p>
          </div>
          ...
          <div className="p-6 hover:shadow-lg hover:-translate-y-2 duration-200 border rounded-xl bg-white dark:bg-slate-800 border-gray-200 dark:border-gray-700">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              Continuously improving our services to bring you the most innovative solutions.
            </p>
          </div>
          ...
          <div className="p-6 hover:shadow-lg hover:-translate-y-2 duration-200 border rounded-xl bg-white dark:bg-slate-800 border-gray-200 dark:border-gray-700">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              Meeting deadlines and providing sustainable solutions tailored to your needs.
            </p>
          </div>
          ...
          <div className="p-6 hover:shadow-lg hover:-translate-y-2 duration-200 border rounded-xl bg-white dark:bg-slate-800 border-gray-200 dark:border-gray-700">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              Providing environmentally friendly solutions to ensure a brighter future.
            </p>
          </div>
        </div>
      </div>
