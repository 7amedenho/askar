      ...
      <div className="relative py-20 border-y-2 border-indigo-700">
        ...
        >
          ...
          <div className="flex flex-1 flex-col gap-5">
            ...
            >
              Delivering Comprehensive and Innovative Solutions Across Industries
            </h2>
            <p className="text-gray-800 dark:text-gray-100 text-justify">
              From mechanical and engineering works to civil projects, metal forming, and fabrication, we provide
              exceptional services tailored to meet your project needs with the highest standards of quality and
              innovation. Our goal is to achieve efficiency and deliver customized solutions that exceed your
              expectations.
            </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-justify">
                      We offer comprehensive solutions for designing and implementing mechanical systems for various
                      industries.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-justify">
                      We execute civil works, including structural construction and infrastructure development, adhering
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-justify">
                      At our facility, we offer metal forming services, spare parts manufacturing, and metal structures
                      fabrication using the latest technologies.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            <div
                className="absolute inset-x-0 bottom-0 h-2/4 bg-gradient-to-tr from-gray-100 to-gray-300 dark:from-slate-900 dark:to-slate-700 rounded-3xl"></div>
            <Image
                src="https://res.cloudinary.com/dvhcaimzt/image/upload/w_1000/q_auto/f_auto/v1732971157/oocqdgtbi2wkosg1te77.png"
                width={700}
                height={700}
                alt="Person working on metal fabrication"
