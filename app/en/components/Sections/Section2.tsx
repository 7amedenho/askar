      ...
      <main className="bg-gradient-to-br from-slate-900 via-gray-800 to-gray-900 overflow-hidden">
        ...
        >
          ...
          <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 relative">
            ...
            <div className="flex lg:text-left flex-col lg:items-center lg:flex-row gap-8 lg:gap-10 xl:gap-12 relative max-w-4xl lg:max-w-none">
              <div className="space-y-8 xl:space-y-10 lg:py-12 flex-1 text-left lg:w-1/2">
                ...
                <p className="text-gray-700 dark:text-gray-300 max-w-md mx-auto lg:max-w-none text-justify">
                  At Askar General Contracting, our engineers and trained
                  workers are the backbone of our success. With experience,
                  precision, and a commitment to quality, our team works
                  cohesively to deliver projects that exceed expectations—on
                  time and within budget. We are your trusted partner in
