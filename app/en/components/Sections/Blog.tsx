...
const Blog = () => {
    return (
        <section
            className="relative py-20 bg-gradient-to-br from-gray-100 via-gray-200 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 overflow-hidden">
            {/* Background Shapes */}
            <div className="absolute inset-0">
                {/* Left Geometric Shape */}
                <div
                    className="absolute top-0 left-0 w-48 h-48 bg-indigo-300 dark:bg-indigo-700 rounded-full opacity-30"></div>
                {/* Right Geometric Shape */}
                <div
                    className="absolute bottom-0 right-0 w-64 h-64 bg-gray-400 dark:bg-slate-700 rounded-full opacity-20"></div>
                {/* Wavy Line */}
                <div
                    className="absolute top-1/2 left-0 w-72 h-1 bg-gradient-to-r from-indigo-500 to-blue-500 opacity-50 transform -translate-y-1/2 rotate-45"></div>
            </div>
            ...
            <div className="relative max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 space-y-10">
                <div className="text-center space-y-6 max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-700 dark:text-slate-100">
                        We offer high-level civil and mechanical projects, ensuring excellence, reliability, and
                        innovation in every detail.
                    </p>
                </div>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div
                        className="bg-white hover:-translate-y-2 duration-300 dark:bg-slate-800 shadow-lg shadow-gray-200/50 dark:shadow-transparent border border-gray-200/50 dark:border-slate-700/50 rounded-lg">
                        <Image
