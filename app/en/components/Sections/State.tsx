        ...
        >
            <div className="container mx-auto">
                <div className="max-w-4xl mx-auto px-5 text-center text-white">
                    <div
                        className="grid sm:grid-cols-1 lg:grid-cols-3 gap-28 max-sm:justify-center max-sm:text-center max-sm:gap-5">
                        {/* Projects */}
                        ...
                        <div className="flex items-center border-2 border-white p-2">
                            <LuTimer className="text-6xl"/>
                            <div>
                                <h2 className="text-4xl sm:text-5xl font-bold">
                                    <CountUp end={20} duration={1} enableScrollSpy/>+
                                </h2>
                                <p className="text-gray-300 text-nowrap">Years of Experience</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center border-2 border-white p-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-nowrap">Team Members</p>
                            </div>
                        </div>
                    </div>
                </div>
