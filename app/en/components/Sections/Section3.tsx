            ...
            >
                <div
                    ...
                    <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 hidden lg:block">
                        <span
                            className="absolute -left-6 md:left-4 top-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12 rounded-3xl bg-pink-500 dark:bg-pink-500 blur-xl opacity-60 lg:opacity-95 hidden"/>
                        <span
                            className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-indigo-600 dark:bg-indigo-600 blur-xl opacity-80"/>
                    </div>
                    <span
                        className="w-4/12 lg:w-2/12 aspect-square bg-gradient-to-tr from-indigo-600 to-pink-500 absolute -top-5 lg:left-0 rounded-full skew-y-12 blur-2xl opacity-40 skew-x-12 rotate-90"/>
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 via-blue-600 to-pink-500">
            Askar Factory{" "}
                        ...
                        <p className="mt-8 text-gray-600 dark:text-gray-300 text-justify">
                            At Askar Factory, we take pride in being a fully-equipped, modern facility that offers
                            integrated solutions for metal forming and precision machining. Our advanced technologies
                            and expertise enable us to meet the needs of various industries, providing reliable,
                            high-quality, and innovative services. From custom designs to large-scale production, we are
        ...
        lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2"
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 via-blue-600 to-pink-500">
            Quality and Excellence{" "}
                        ...
                        >
                            At Askar Factory, we believe that quality is the foundation of success. We work hard to
                            deliver highly efficient metal products that meet the highest global standards. Our
                            specialized team is always striving for innovation to ensure the satisfaction of our
                            customers and partners in success. At Askar Factory for Metal Forming, we focus on the
                            finest details to guarantee the best results. Our products combine durability and beauty,
                            making them the ideal choice for contracting companies and major projects. Because we
                            understand the importance of time and quality, we offer innovative solutions executed on
                            time and with the highest standards of quality.
                        </p>
                    </div>
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 via-blue-600 to-pink-500">
            Excellence and Technology{" "}
                        ...
                        <p
                            className="mt-8 text-gray-600 dark:text-gray-300 text-justify"
                        >
                            Askar Factory integrates advanced technologies and innovative methods to produce
                            high-quality metal products that cater to diverse needs. Our expertise in precision
                            machining and metal forming enables us to deliver products that stand out in terms of
                            durability, accuracy, and design. We ensure that every product leaving our facility is
                            crafted to perfection, meeting global standards of excellence.
                        </p>
                    </div>
