        ...
        return (
            ...
            >
                <div className="container py-24 mx-auto flex flex-col lg:flex-row items-center lg:items-start">
                    {/* Map */}
                    <div className="lg:w-2/3 w-full lg:mb-0 relative mx-5">
                        <div
                            className="bg-gray-300 dark:bg-gray-800 rounded-lg overflow-hidden flex items-end justify-start relative h-screen">
                            <iframe
                                width="100%"
                                height="100%"
                            ...
                            >
                                <div className="w-1/2 px-4">
                                    ...
                                    <p className="mt-1 text-sm">
                                        Alexandria – Al-Amiriya – Nahda Road – Karnak 1
                                    </p>
                                </div>
                                <div className="w-1/2 px-4">
                                    <h2 className="font-semibold text-gray-900 dark:text-gray-200 tracking-widest text-xs">
                    ...
                    >
                        <h2 className="text-gray-900 dark:text-gray-200 text-2xl mb-3 font-medium">
                            Contact Askar Company
                        </h2>
                        <p className="leading-relaxed mb-5 text-gray-600 dark:text-gray-400">
                            Have a question or want to collaborate? Fill out the form below, and we will get back to you
                            soon!
                        </p>
