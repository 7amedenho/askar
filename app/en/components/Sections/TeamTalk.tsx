...
const TeamTalk = () => {
    const testimonials = [
        ...
        {
            quote: "Effective management is the key to achieving our goals, fostering innovation, and excelling in our work environment.",
            name: "Adel Mohamed Askar",
            position: "Administrative Director",
        },
        {
            quote: "In mechanical engineering, we provide innovative solutions focused on quality, efficiency, and customer satisfaction.",
            name: "Asem Abdel Rahman Abu Asal",
            position: "Mechanical Engineer",
        },
        {
            quote: "Civil engineering is fundamental to infrastructure, ensuring durability and sustainability for future generations.",
