      ...
      >
        ...
        <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 relative z-10">
          <div className="mx-auto text-center max-w-xl">
            ...
            >
              مجموعة عسكر للمقاولات
            </h1>
          </div>
          <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:gap-x-14 gap-y-8 md:items-end">
            <div className="space-y-4 md:space-y-6 md:col-span-2 lg:col-span-1 w-full max-w-3xl lg:max-w-none mx-auto lg:mx-0 text-center lg:text-right">
              <h2 className="font-display font-semibold text-lg md:text-3xl text-white">
                عن شركة عسكر للمقاولات العامة
              </h2>
              <div className="text-white space-y-3 mx-auto max-w-2xl lg:max-w-none text-justify">
                <p>
                  تأسست شركة عسكر للمقاولات العامة في عام 2004، وهي متخصصة في الأعمال الميكانيكية والمدنية، تجمع بين الخبرة والابتكار لتقديم خدمات عالية الجودة تلبي احتياجات العملاء.
                </p>

                <p>
                  رؤيتنا: أن نكون من الشركات الرائدة في مجال المقاولات العامة والأعمال الميكانيكية، مع التركيز على الابتكار والجودة.
                </p>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="max-w-full relative">
                ...
                <Image
                  ...
                  width={1000}
                  height={1000}
                  alt="شعار عسكر للمقاولات العامة"
